import logo from '../assets/images/VylogoGold2.png';
import GithubIconComponent from './icons/GithubIconComponent';


function Footer() {
    return (
            <footer className="w-full text-white bg-gradient-third body-font relative z-10">
                <div
                    ...
                    <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                        <img classNameName="custom-logo scale-50" src={logo} alt="Vedat Yalçınkaya Logo" />
                        <p className="text-sm text-white-500">Design, Code and Ship!</p>
                        <div className="mt-2">
                            <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                                <a className="text-white-500 cursor-pointer hover:text-white-700">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        className="w-5 h-5" viewBox="0 0 24 24">
                                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                                    </svg>
                                </a>
                                <a className="ml-3 text-white-500 cursor-pointer hover:text-white-700">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        className="w-5 h-5" viewBox="0 0 24 24">
                                        <path
                    ...
                    <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                        ...
                        <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                            ...
                            <nav className="mb-10 list-none">
                                ...
                                <li className="mt-3">
                                    <a className="text-white-500 cursor-pointer hover:text-white-900">Request a Quote</a>
                                </li>
                                <li className="mt-3">
                                    <a className="text-white-500 cursor-pointer hover:text-white-900">+123-456-7890</a>
                                </li>
                            </nav>
                        </div>
                    </div>
                ...
                <div className="bg-gray-300">
                    <div className="container px-5 py-4 mx-auto">
                        <p className="text-sm text-white-700 capitalize xl:text-center">© 2020 All rights reserved </p>
                    </div>
                </div>
            </footer>
    );
