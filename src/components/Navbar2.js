      ...
      <nav className="bg-gradient-primary shadow-md relative z-10">
        <div className="flex justify-between items-center mx-auto max-w-full px-3 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-4">
            <img
              className="custom-logo my-4"
              src={logo}
              alt="Vedat Yalçınkaya Logo"
            />
        ...
        {/* Navigasyon Linkleri */}
        <div className="hidden lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-8">
          <Link
            to="/"
            className="block text-3xl text-primary-700 font-josefin font-bold hover:text-primary hover:scale-125 transition-transform duration-300 ease-in-out"
          >
            {t.home}
          </Link>
          <Link
        ...
        {/* Hamburger Menüsü ve Dil Değiştirici */}
